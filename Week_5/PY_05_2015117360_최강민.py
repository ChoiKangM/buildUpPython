...
class Student(Person):
  ...
  # def __str__(self):
  #   return ("[학생] 이름 : "+str(self.name)+" 전화번호: "+str(self.phone)+" 학과 :"+str(self.major)+" 학번:"+str(self.schoolNum))
...
class Worker(Person):
  ...
  # def __str__(self):
  #   return ("[사원] 이름 : "+str(self.name)+" 전화번호:"+str(self.phone)+" 부서 :"+str(self.depart)+" 사번:"+str(self.companyNum))
